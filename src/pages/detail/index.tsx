...
import { composeAsync as mailComposeAsync } from 'expo-mail-composer'
        ...
        <View style={styles.container}>
            ...
            <View style={styles.contactBox}>
                ...
                <View style={styles.actions}>
                    ...
                    <TouchableOpacity style={styles.action} onPress={async () => { await sendMail() }}>
